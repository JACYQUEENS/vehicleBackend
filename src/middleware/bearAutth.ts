...
interface DecodedToken {
    ...
    role: 'admin' | 'user'; // User's role in the system
...
declare module "hono" {
    interface Context {
        user?: DecodedToken;  // Optional user object populated after auth
    }
}
...
export const authMiddleware = async (c: Context, next: Next, requiredRole: role) => {
